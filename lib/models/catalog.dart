...
class CataLOgModel {
  ...
  static List<Item> items = [
    ...
    Item(4, "Playstation 5", "Sony Playstation 5th generation", 500, "#544ee4",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMOMstwtmLnjFb3NHiDJ_kcQnueNVH-rv_3ps96HZmXlFumKWaiBqq_L4Uoyx3iFiNTrXNEbyB&usqp=CAc"),
    Item(5, "Airpods Pro", "Apple Aipods Pro 1st generation", 200, "#e3e4e9",
    ...
    Item(6, "iPad Pro", "Apple iPad Pro 2020 edition", 799, "#f73984",
    ...
    Item(8, "Galaxy S21", "Samsung Galaxy S21 2021 edition", 899, "#7c95eb",
